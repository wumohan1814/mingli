 ...
 */
import { EARTHLY_BRANCHES, HEAVENLY_STEMS, SIXTY_CYCLE } from '../ganzhi/data.js';
// 地支
...
// 用于快速查找卦象所属宫位
export const hexagramPalaceMap = Object.entries(palaceHexagrams).reduce((acc, [palace, hexagrams]) => {
...
export const qimen = {
    ...
    // 八神从值符起按洛书八宫排布，阴阳遁差异由排布方向决定。
    yangGods: ['值符', '九天', '九地', '玄武', '白虎', '六合', '太阴', '螣蛇'],
    yinGods: ['值符', '九天', '九地', '玄武', '白虎', '六合', '太阴', '螣蛇'],
    ninePositions: [
