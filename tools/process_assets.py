...
ROOT = os.path.normpath(os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "frontend", "public", "art"))
...
BATCH = [
    # #2 签条
    {"src": os.path.join(ROOT, "ssgw", "Isolated_product_asset__transp_2026-09-07T18-22-09.png"),
     "subdir": "ssgw", "base": "ssgw-stick", "tw": 90, "th": 360, "limit_kb": 150,
     "mode": "transparent", "remove_wm": False},
    # #3 塔罗牌背
    {"src": os.path.join(ROOT, "card-back", "card-back-tarot_raw.png"),
     "subdir": "card-back", "base": "card-back-tarot", "tw": 480, "th": 800, "limit_kb": 300,
     "mode": "opaque", "remove_wm": True},
    # #4 雷诺曼牌背
    {"src": os.path.join(ROOT, "card-back", "card-back-lenormand_raw.png"),
     "subdir": "card-back", "base": "card-back-lenormand", "tw": 480, "th": 800, "limit_kb": 300,
     "mode": "opaque", "remove_wm": True},
    # #5 铜钱字面
    {"src": os.path.join(ROOT, "liuyao", "Isolated_product_asset__transp_2026-09-07T18-22-30.png"),
     "subdir": "liuyao", "base": "coin-face", "tw": 192, "th": 192, "limit_kb": 200,
     "mode": "transparent", "remove_wm": False},
    # #6 铜钱图案面
    {"src": os.path.join(ROOT, "liuyao", "Isolated_product_asset__transp_2026-09-07T18-22-28.png"),
